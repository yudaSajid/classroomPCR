<div class="text-gray-800 dark:text-gray-200 min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <div class="flex items-center p-5 bg-gray-200 dark:bg-gray-800 rounded-t-lg shadow-lg">
        ...
        <h2 class="ml-3 text-2xl font-bold text-gray-900 dark:text-white">Leaderboard on <span class="text-yellow-600 dark:text-yellow-400"><?php echo e($courseName); ?></span></h2>
    </div>

    <div class="p-6 bg-gray-100 dark:bg-gray-900">
        
        <!--[if BLOCK]><![endif]--><?php if(count($topPoints) > 0): ?>
            <div class="flex flex-col md:flex-row items-end justify-center gap-x-6 mb-10">
                
                <!--[if BLOCK]><![endif]--><?php if(isset($topPoints[1])): ?>
                <div class="order-2 md:order-1 w-full md:w-1/4 text-center mt-6 md:mt-0 transition-transform duration-300 transform hover:scale-105">
                    <div class="relative inline-block p-2 bg-gray-200 dark:bg-gray-700 rounded-xl border-b-4 border-gray-300 dark:border-gray-600">
                        <img src="<?php echo e($topPoints[1]->avatar); ?>" class="w-20 h-20 mx-auto rounded-full object-cover shadow-lg ring-4 ring-gray-400 dark:ring-gray-500" alt="<?php echo e($topPoints[1]->name); ?>">
                    ...
                    <h3 class="mt-3 text-lg font-semibold text-gray-800 dark:text-gray-200"><?php echo e($topPoints[1]->name); ?></h3>
                    <p class="text-base text-gray-600 dark:text-gray-400"><?php echo e($topPoints[1]->formatted_points); ?> Pts</p>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                
                <!--[if BLOCK]><![endif]--><?php if(isset($topPoints[0])): ?>
                <div class="order-1 md:order-2 z-10 w-full md:w-1/3 text-center transition-transform duration-300 transform hover:scale-105">
                    <div class="relative inline-block p-3 bg-yellow-300 dark:bg-yellow-700 rounded-xl border-b-4 border-yellow-400 dark:border-yellow-600">
                        <img src="<?php echo e($topPoints[0]->avatar); ?>" class="w-24 h-24 mx-auto rounded-full object-cover shadow-xl ring-4 ring-yellow-500 dark:ring-yellow-400" alt="<?php echo e($topPoints[0]->name); ?>">
                    ...
                    <h3 class="mt-4 text-xl font-bold text-yellow-800 dark:text-yellow-200"><?php echo e($topPoints[0]->name); ?></h3>
                    <p class="font-semibold text-lg text-yellow-700 dark:text-yellow-400"><?php echo e($topPoints[0]->formatted_points); ?> Pts</p>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                
                <!--[if BLOCK]><![endif]--><?php if(isset($topPoints[2])): ?>
                <div class="order-3 md:order-3 w-full md:w-1/4 text-center mt-6 md:mt-0 transition-transform duration-300 transform hover:scale-105">
                    <div class="relative inline-block p-2 bg-orange-200 dark:bg-orange-700 rounded-xl border-b-4 border-orange-300 dark:border-orange-600">
                        <img src="<?php echo e($topPoints[2]->avatar); ?>" class="w-20 h-20 mx-auto rounded-full object-cover shadow-lg ring-4 ring-orange-400 dark:ring-orange-500" alt="<?php echo e($topPoints[2]->name); ?>">
                    ...
                    <h3 class="mt-3 text-lg font-semibold text-gray-800 dark:text-gray-200"><?php echo e($topPoints[2]->name); ?></h3>
                    <p class="text-base text-gray-600 dark:text-gray-400"><?php echo e($topPoints[2]->formatted_points); ?> Pts</p>
                </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        <?php else: ?>
        ...
        <div class="mt-8">
            ...
            <div class="space-y-3">
                <?php $__currentLoopData = $topPoints; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="flex items-center p-3 transition-all duration-300 bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg hover:bg-gray-50 dark:hover:bg-gray-700 transform hover:-translate-y-0.5">
                        <div class="w-10 text-xl font-bold text-center text-gray-600 dark:text-gray-300"><?php echo e($index + 1); ?></div>
                        <img src="<?php echo e($point->avatar); ?>" class="w-12 h-12 ml-4 rounded-full object-cover ring-2 ring-gray-200 dark:ring-gray-700" alt="<?php echo e($point->name); ?>">
                        <div class="ml-4 flex-grow">
                            <h4 class="font-semibold text-gray-900 dark:text-gray-100"><?php echo e($point->name); ?></h4>
                        </div>
                        <div class="ml-auto text-lg font-bold text-gray-800 dark:text-gray-200"><?php echo e($point->formatted_points); ?> Pts</div>
                    </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if($currentUserRank): ?>
    <div class="p-5 bg-gray-200 dark:bg-gray-800 rounded-b-lg shadow-inner mt-4">
        <div class="flex items-center">
            <div class="w-14 text-2xl font-bold text-center text-gray-800 dark:text-white">#<?php echo e($currentUserRank); ?></div>
            <img src="<?php echo e(Auth::user()->profile_photo_url); ?>" class="w-14 h-14 ml-4 rounded-full object-cover ring-3 ring-fuchsia-500 shadow-md" alt="<?php echo e(Auth::user()->name); ?>">
            <div class="ml-4 flex-grow">
            ...
            <div class="ml-auto text-xl font-bold text-fuchsia-600 dark:text-fuchsia-400"><?php echo e($currentUserPoints); ?> Pts</div>
        </div>
    </div>
    <?php else: ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH D:\Coding\plisBisa\resources\views/livewire/courses/leaderboard.blade.php ENDPATH**/ ?>